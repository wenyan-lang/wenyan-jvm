...
//
    public static void main(String[] args) {
        String project = "/Users/luchangcun/Projects/new/wenyan-jvm/project_example";
        ...
        impl.compile("-c","@"+makeFile,out,"-sc",sc,"-m","main.主文件","-g","-wyg",sc);
        impl.compile("-o","/Users/luchangcun/Projects/new/wenyan-jvm/project_example/target/","-n","main.主文件","-r");
    }
}
